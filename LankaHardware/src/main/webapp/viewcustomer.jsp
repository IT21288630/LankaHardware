        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header" id="AddEmoloyeeModalHeader">
              <h5 class="modal-title" id="modalCenterTitle">View customer</h5>
              <button
                type="button"
                class="btn-close"
              ...
              <div>
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" id = "save" onclick ="callUpdateCustomerServlet()">Update  details</button>
                          <button type="reset" class="btn btn-outline-secondary" id ="clear" onclick = "RemoveCustomer()">Remove</button>
                        </div>
                      </form>
                    </div>
              </div>
