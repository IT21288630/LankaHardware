        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4" id="breadCrumbHeading">Charts</h4>
				...
				<div style="display: flex; justify-content: center;">
					<h2 class="fw-bold" style="margin-bottom: 0px;">Attendance Chart</h2>
				</div>
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                      <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Attendance Management</h5>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
				...
				<div style="display: flex; justify-content: center;">
					<h2 class="fw-bold" style="margin-bottom: 0px;">Employee Chart</h2>
				</div>
                ...
                <div class="col-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Employee Chart</h5>
