                  ...
                  <table class="table">
                    ...
                    <!-- <c:forEach var="user" items="${listUser}">
						...
						<tr>
							...
							<td><a href="<%=request.getContextPath()%>/edit?orderID=<c:out value='${user.orderID}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="<%=request.getContextPath()%>/delete?orderID=<c:out value='${user.orderID}' />" onclick="openPopup()">Delete</a></td>
