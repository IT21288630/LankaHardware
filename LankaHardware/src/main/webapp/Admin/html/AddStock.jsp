...
>
  <head>
    ...
    <title>Stock settings - Add Stock</title>
                    ...
                    <div class="card-body">
                      <form method="POST" onsubmit="return false">
                        ...
                        <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" name="stockCat">
                          ...
                          <option value="hardware tools"></option>Hardware tools</opt ion>
                        </select>
                         <small class ="errorCat"></small>
                         </div>
                        
                
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Brand</label>
                          <input type="text" class="form-control" id="basic-default-company" placeholder="ACME Inc." name="stockBrand">
                          <small class ="errorBrand"></small>
                        </div>
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                          ...
                          <input class="form-control" type="date" value="2021-06-18" id="html5-date-input" name = "stockMf">
                           <p class ="errorMF"></p>
                        </div>
                        
                         <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Expire Date</label>
                          <input class="form-control" type="date" value="2024-06-18" id="html5-date-input" name = "stockExp">
                           <p class ="errorExp"></p>
                        </div>
