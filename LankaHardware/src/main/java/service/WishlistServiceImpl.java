...
public class WishlistServiceImpl implements IWishlistService {
	...
	public static void main(String[] args) {
		...
		System.out.println(iWishlistService.sendBackInStockEmail("i200"));
	}
}
